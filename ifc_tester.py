...
#	cmd = f'/Applications/Google\\ Chrome.app/Contents/MacOS/Google\\ Chrome --user-data-dir=/tmp/chrome --enable-quic --remote-debugging-port={remote_debugging_port} --headless' 
	cmd = f'{chrome_path} --enable-quic --remote-debugging-port={remote_debugging_port} --headless' 
